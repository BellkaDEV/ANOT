...
const S = StyleSheet.create({
  ...
  cell:      { flex: 1, height: 38, alignItems: "center", justifyContent: "center", borderRadius: 10, margin: 2, position: "relative" },
  cellEmpty: { flex: 1, height: 38, margin: 2 },
  cellToday: { borderRadius: 10 },
  cellSel:   { borderRadius: 10 },
  cellText:  { fontSize: 13, marginTop: -3 },
